const express = require('express');// Configuração do banco de dados PostgreSQL (Supabase)
const pool = new Pool({
...
module.exports.handler = serverless(app);onst mysql = require('mysql2/promise');
const { body, validationResult } = require('express-validator');
require('dotenv').config();
